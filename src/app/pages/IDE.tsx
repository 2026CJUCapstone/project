      ...
      <PanelGroup direction="horizontal" className="w-full h-full" id="main-horizontal-group">
        ...
        <Panel defaultSize={isGraphViewerOpen ? 75 : 100} minSize={30} id="editor-console-panel" order={1}>
          <PanelGroup direction="vertical" className="w-full h-full" id="editor-vertical-group">
            ...
            <PanelResizeHandle className="h-2 bg-[#1e1e1e] border-y border-[#333] hover:bg-blue-600/50 transition-colors cursor-row-resize flex items-center justify-center relative z-10" id="editor-vertical-resize">
        ...
        {isGraphViewerOpen && (
          <>
            <PanelResizeHandle className="w-2 bg-[#1e1e1e] border-x border-[#333] hover:bg-blue-600/50 transition-colors cursor-col-resize flex flex-col items-center justify-center relative z-10" id="main-horizontal-resize">
              <div className="h-12 w-0.5 bg-gray-500 rounded-full" />
            </PanelResizeHandle>
