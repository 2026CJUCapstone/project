...
export function ProblemFormModal({ onClose, onSubmit, initialData }: Props) {
  ...
  const [difficulty, setDifficulty] = useState<ProblemCreateRequest["difficulty"]>(initialData?.difficulty ?? "beginner");
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onSubmit({ title, difficulty, tags, description, testCases });
  };
    ...
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
      ...
      >
        ...
        <div className="flex flex-col gap-2">
          <label className="text-sm font-medium text-gray-700">테스트 케이스</label>
